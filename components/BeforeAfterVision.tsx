      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            In 2024, there are only two types of Idaho businesses: 
            those using AI to dominate, and those getting left behind. 
            ...
            <div className="space-y-6">
              ...
              <div className="bg-red-950/50 border-2 border-red-900 rounded-2xl p-8 mb-8">
                ...
                <p className="text-lg text-red-200 leading-relaxed">
                  You're working harder than ever, but revenue is down 30%. Your top competitor 
                  just launched AI-powered instant quoting—they're stealing 5 customers a week from you. 
                  Your best employee quit because they're tired of manual data entry. You're considering 
                  closing shop because you can't compete anymore. <span className="font-bold text-red-400">This 
                  isn't a prediction—it's happening to Idaho businesses right now.</span>
                </p>
              </div>
              ...
              <div className="bg-gray-800 rounded-2xl p-8 text-center mt-8">
                <p className="text-2xl font-bold text-red-400 mb-4">
                  "I wish I had started with AI sooner. We lost 40% of our business 
                  to competitors who moved faster."
                </p>
                <p className="text-gray-500">- Former Idaho business owner (closed 2024)</p>
              </div>
            </div>
          ) : (
            <div className="space-y-6">
              ...
              <div className="bg-green-950/50 border-2 border-green-900 rounded-2xl p-8 mb-8">
                ...
                <p className="text-lg text-green-200 leading-relaxed">
                  You just landed your biggest client ever—they chose you because your AI-powered 
                  service blew them away. You're working 30 hours a week instead of 70, spending 
                  weekends with family. Revenue is up 45% with half the effort. Your competitors 
                  are desperately trying to catch up, but you're always one step ahead. 
                  <span className="font-bold text-green-400">You have a secret weapon: a dedicated 
                  AI partner who keeps you on the cutting edge.</span>
                </p>
              </div>
              ...
              <div className="bg-gray-800 rounded-2xl p-8 text-center mt-8">
                <p className="text-2xl font-bold text-green-400 mb-4">
                  "Idaho AI didn't just give us software—they gave us a competitive edge 
                  that's made us the leader in our market."
                </p>
                <p className="text-gray-500">- Mike S., Boise Construction (Revenue up 300%)</p>
              </div>
            </div>
          )}
        </div>
